            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    "Welcome to Chaimae's Corner, a space where learning comes to life through personalized mentorship and interactive online meetings."
                  }
                </Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
